...
<p> Click to open  <a href= "https://book-full.onrender.com/books" > All Books</a>  on  MED Book Shelf </p>
<p> Check if here is not your favorite book. Let's say it's not; </p>
<p>Quickly go to  <a href="https://book-full.onrender.com/add"> Add Books</a>  page. </p>
<p>Observe the form which will let you to add your favorite one. </p>
<p> Enter the required information that has been asked.</p>
<p>Once you click the button can see your favorite book at the bottom of the<a href= "https://book-full.onrender.com/books" > list.</a> </p>
